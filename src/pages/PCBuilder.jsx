...
const PARTS = {
  cpu: [
    { id: 'cpu1', name: 'Intel Core i9-14900K', brand: 'Intel', socket: 'LGA1700', img: img('Core i9-14900K', '0f2742'), price: 68500, watt: 125, perf: 98, specs: ['24 Cores / 32 Threads', '6.0GHz Turbo', 'LGA 1700'] },
    { id: 'cpu2', name: 'AMD Ryzen 7 7800X3D', brand: 'AMD', socket: 'AM5', img: img('Ryzen 7 7800X3D', 'a01406'), price: 45000, watt: 120, perf: 92, specs: ['8 Cores / 16 Threads', '5.0GHz Boost', 'AM5'] },
    { id: 'cpu3', name: 'Intel Core i5-14600K', brand: 'Intel', socket: 'LGA1700', img: img('Core i5-14600K', '0f2742'), price: 32000, watt: 100, perf: 80, specs: ['14 Cores / 20 Threads', '5.3GHz Turbo', 'LGA 1700'] },
    { id: 'cpu4', name: 'AMD Ryzen 5 7600', brand: 'AMD', socket: 'AM5', img: img('Ryzen 5 7600', 'a01406'), price: 24000, watt: 65, perf: 70, specs: ['6 Cores / 12 Threads', '5.1GHz Boost', 'AM5'] },
  ],
  motherboard: [
    { id: 'mb1', name: 'ASUS ROG Strix Z790-E', brand: 'ASUS', socket: 'LGA1700', ram: 'DDR5', form: 'ATX', img: img('ROG Z790-E', '111827'), price: 52000, watt: 50, specs: ['LGA 1700', 'DDR5, WiFi 6E', 'ATX'] },
    { id: 'mb2', name: 'MSI MAG B650 Tomahawk', brand: 'MSI', socket: 'AM5', ram: 'DDR5', form: 'ATX', img: img('B650 Tomahawk', '111827'), price: 28000, watt: 45, specs: ['AM5', 'DDR5', 'ATX'] },
    { id: 'mb3', name: 'Gigabyte B760M DS3H', brand: 'Gigabyte', socket: 'LGA1700', ram: 'DDR5', form: 'mATX', img: img('B760M DS3H', '111827'), price: 16500, watt: 40, specs: ['LGA 1700', 'DDR5', 'Micro-ATX'] },
  ],
  ram: [
    { id: 'ram1', name: 'Corsair Vengeance 32GB DDR5 6000MHz', brand: 'Corsair', type: 'DDR5', img: img('Vengeance 32GB', '4a1d96'), price: 14500, watt: 10, specs: ['2x16GB', '6000MHz', 'RGB'] },
    { id: 'ram2', name: 'G.Skill Trident Z5 16GB DDR5', brand: 'G.Skill', type: 'DDR5', img: img('Trident Z5 16GB', '4a1d96'), price: 8500, watt: 8, specs: ['2x8GB', '5600MHz', 'RGB'] },
    { id: 'ram3', name: 'Corsair Vengeance 64GB DDR5', brand: 'Corsair', type: 'DDR5', img: img('Vengeance 64GB', '4a1d96'), price: 28000, watt: 14, specs: ['2x32GB', '6000MHz', 'RGB'] },
  ],
  gpu: [
    { id: 'gpu1', name: 'ASUS ROG RTX 4090 24GB', brand: 'NVIDIA', img: img('RTX 4090', '0a5c2e'), price: 215000, watt: 450, perf: 100, specs: ['24GB GDDR6X', 'PCIe 4.0', 'Triple Fan'] },
    { id: 'gpu2', name: 'Gigabyte RTX 4070 Ti 12GB', brand: 'NVIDIA', img: img('RTX 4070 Ti', '0a5c2e'), price: 95000, watt: 285, perf: 78, specs: ['12GB GDDR6X', 'PCIe 4.0', 'Dual Fan'] },
    { id: 'gpu3', name: 'MSI RTX 4060 Ti 8GB', brand: 'NVIDIA', img: img('RTX 4060 Ti', '0a5c2e'), price: 52000, watt: 160, perf: 58, specs: ['8GB GDDR6', 'PCIe 4.0', 'Dual Fan'] },
    { id: 'gpu4', name: 'AMD Radeon RX 7800 XT', brand: 'AMD', img: img('RX 7800 XT', 'a01406'), price: 68000, watt: 263, perf: 72, specs: ['16GB GDDR6', 'PCIe 4.0', 'Triple Fan'] },
  ],
  storage: [
    { id: 'st1', name: 'Samsung 990 PRO 2TB NVMe', brand: 'Samsung', img: img('990 PRO 2TB', '1a4a7a'), price: 24500, watt: 8, specs: ['7450MB/s', 'PCIe 4.0', 'M.2 NVMe'] },
    { id: 'st2', name: 'WD Black SN770 1TB NVMe', brand: 'WD', img: img('SN770 1TB', '1a4a7a'), price: 11000, watt: 6, specs: ['5150MB/s', 'PCIe 4.0', 'M.2 NVMe'] },
    { id: 'st3', name: 'Seagate Barracuda 2TB HDD', brand: 'Seagate', img: img('Barracuda 2TB', '1a4a7a'), price: 6500, watt: 9, specs: ['7200 RPM', 'SATA III', '256MB Cache'] },
  ],
  psu: [
    { id: 'psu1', name: 'Corsair RM1000x 1000W Gold', brand: 'Corsair', wattage: 1000, img: img('RM1000x 1000W', '7c3aed'), price: 18500, watt: 0, specs: ['1000W', '80+ Gold', 'Fully Modular'] },
    { id: 'psu2', name: 'Cooler Master MWE 750W Gold', brand: 'Cooler Master', wattage: 750, img: img('MWE 750W', '7c3aed'), price: 11000, watt: 0, specs: ['750W', '80+ Gold', 'Modular'] },
    { id: 'psu3', name: 'Antec CSK 650W Bronze', brand: 'Antec', wattage: 650, img: img('CSK 650W', '7c3aed'), price: 7500, watt: 0, specs: ['650W', '80+ Bronze', 'Non-Modular'] },
  ],
  case: [
    { id: 'cs1', name: 'NZXT H7 Flow RGB', brand: 'NZXT', form: 'ATX', img: img('NZXT H7 Flow', '374151'), price: 13500, watt: 15, specs: ['Mid Tower', 'ATX', '4x RGB Fans'] },
    { id: 'cs2', name: 'Lian Li Lancool 216', brand: 'Lian Li', form: 'ATX', img: img('Lancool 216', '374151'), price: 11000, watt: 12, specs: ['Mid Tower', 'ATX', '3x Fans'] },
    { id: 'cs3', name: 'Cooler Master NR200P', brand: 'Cooler Master', form: 'mATX', img: img('NR200P', '374151'), price: 12000, watt: 8, specs: ['Mini ITX', 'mATX', 'Compact'] },
  ],
  cooler: [
    { id: 'cl1', name: 'NZXT Kraken 360 AIO', brand: 'NZXT', img: img('Kraken 360', '0891b2'), price: 22000, watt: 25, specs: ['360mm AIO', 'LCD Display', 'RGB'] },
    { id: 'cl2', name: 'DeepCool AK620 Air Cooler', brand: 'DeepCool', img: img('AK620', '0891b2'), price: 7500, watt: 12, specs: ['Dual Tower', 'Air Cooling', '260W TDP'] },
    { id: 'cl3', name: 'Corsair iCUE H150i 360mm', brand: 'Corsair', img: img('H150i 360', '0891b2'), price: 24000, watt: 28, specs: ['360mm AIO', 'RGB', 'Quiet'] },
  ],
  monitor: [
    { id: 'mn1', name: 'LG UltraGear 27" 240Hz QHD', brand: 'LG', img: img('UltraGear 27', 'be123c'), price: 52000, watt: 45, specs: ['2560x1440', '240Hz, 1ms', 'IPS'] },
    { id: 'mn2', name: 'Samsung Odyssey G7 32" Curved', brand: 'Samsung', img: img('Odyssey G7', 'be123c'), price: 68000, watt: 60, specs: ['2560x1440', '240Hz Curved', 'VA'] },
    { id: 'mn3', name: 'ASUS TUF 24" 165Hz FHD', brand: 'ASUS', img: img('TUF 24', 'be123c'), price: 22000, watt: 35, specs: ['1920x1080', '165Hz, 1ms', 'IPS'] },
  ],
};
...
const PCBuilder = () => {
  ...
  const selectPart = (slot, part) => {
    ...
    setOpenSlot(null);
    success(`${part.name} added to build`);
  };
  ...
  const stats = useMemo(() => {
    ...
    const totalWatt = parts.reduce((s, p) => s + (p.watt || 0), 0) + 80; // base load
    const recommendedPSU = Math.ceil((totalWatt * 1.35) / 50) * 50;

    // FPS estimate from GPU + CPU
  ...
  const addAllToCart = () => {
    const parts = Object.values(build);
    if (parts.length === 0) {
      warning('Add components to your build first');
      return;
    }
    parts.forEach((p) => addItem({ id: p.id, name: p.name, selling_price: p.price, featured_image: p.img }, 1));
    success(`${parts.length} components added to cart!`);
  };
      ...
      <div className="pcb-hero">
        <div className="container pcb-hero-inner">
          <div className="pcb-hero-text">
            ...
            <h1>PC Builder</h1>
            <p>Build your dream PC with real-time compatibility checking, power calculation & FPS estimates</p>
          </div>
        ...
        <aside className="pcb-summary">
          <div className="pcb-summary-card">
            ...
            <div className="pcb-btn-row">
              <button className="pcb-btn-ghost" onClick={() => success('Build saved!')}><FiSave /> Save</button>
              <button className="pcb-btn-ghost" onClick={() => success('Share link copied!')}><FiShare2 /> Share</button>
            </div>
          </div>
        </aside>
      </div>
